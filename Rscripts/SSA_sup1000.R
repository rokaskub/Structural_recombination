...
# Insert size >=1000bp -----------------------------------------------------
bam_files <- list.files("../1_Mapping_bwa_full/bwa_strict/insert_size", "*.ChrM_258128_270303.MD.IS1000.filtered.bam$", full = T)
...
fwrite(filtered_bam.dt, "../Results/SSA_PE_reads_IS_sup1000.raw_reads.csv.gz", sep = ",")
filtered_bam.dt <- fread("../Results/SSA_PE_reads_IS_sup1000.raw_reads.csv.gz")
...
fwrite(others, "../Results/SSA_PE_reads_IS_sup1000.others_count.csv")
...
fwrite(summary.dt, "../Results/SSA_PE_reads_IS_sup1000.count.csv.gz", sep = ",")
